...
contract Wrestling {
    ...
    /**
      ...
      */
    event WrestlingStartsEvent(address wrestler1, wrestler2);
    ...
    /**
      * A second wrestler can register as an oppoent
      */
    ...
    /**
      * Every round a player can put a sum the ether, if one of the player put in twice or
    ...
    function endOfGame(address winner) {
        gameFinished = true;
        theWinner = winner;
